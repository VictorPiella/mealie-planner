...
// In Docker/production builds VITE_API_URL is baked in and used directly.
const API_ROOT = import.meta.env.DEV ? '' : BASE_URL;

// ─── Mock data ──────────────────────────────────────────────────────────────
// Used automatically when no token or when BASE_URL points at localhost:3000.

const MOCK_DISHES: Dish[] = [
  { id: 'd1',  slug: 'grilled-salmon',   name: 'Grilled Salmon',   description: 'Atlantic salmon fillet with lemon herb butter',       category: 'Fish',       tags: ['gluten-free', 'high-protein'] },
  { id: 'd2',  slug: 'beef-bourguignon', name: 'Beef Bourguignon', description: 'Slow-braised beef in red wine with mushrooms',         category: 'Meat',       tags: ['hearty', 'classic'] },
  { id: 'd3',  slug: 'ratatouille',      name: 'Ratatouille',      description: 'Provençal vegetable stew with tomatoes and herbs',     category: 'Vegetarian', tags: ['vegan', 'gluten-free'] },
  { id: 'd4',  slug: 'chicken-caesar',   name: 'Chicken Caesar',   description: 'Grilled chicken breast, romaine, parmesan, croutons', category: 'Poultry',    tags: ['classic'] },
  { id: 'd5',  slug: 'pasta-carbonara',  name: 'Pasta Carbonara',  description: 'Spaghetti with guanciale, egg, pecorino and pepper',  category: 'Pasta',      tags: ['italian', 'rich'] },
  { id: 'd6',  slug: 'mushroom-risotto', name: 'Mushroom Risotto', description: 'Arborio rice with wild mushrooms and truffle oil',     category: 'Vegetarian', tags: ['gluten-free', 'umami'] },
  { id: 'd7',  slug: 'duck-confit',      name: 'Duck Confit',      description: 'Slow-cooked duck leg with cherry gastrique',           category: 'Poultry',    tags: ['french', 'rich'] },
  { id: 'd8',  slug: 'lobster-bisque',   name: 'Lobster Bisque',   description: 'Creamy bisque with cognac and fresh lobster',          category: 'Fish',       tags: ['seafood', 'premium'] },
  { id: 'd9',  slug: 'lamb-tagine',      name: 'Lamb Tagine',      description: 'Moroccan spiced lamb with apricots and almonds',       category: 'Meat',       tags: ['spiced', 'hearty'] },
  { id: 'd10', slug: 'vegetable-curry',  name: 'Vegetable Curry',  description: 'Coconut milk curry with seasonal vegetables',          category: 'Vegetarian', tags: ['vegan', 'spiced'] },
  { id: 'd11', slug: 'tuna-tartare',     name: 'Tuna Tartare',     description: 'Fresh yellowfin tuna with avocado and sesame',        category: 'Fish',       tags: ['raw', 'light'] },
  { id: 'd12', slug: 'beef-tenderloin',  name: 'Beef Tenderloin',  description: 'Pan-seared fillet with truffle jus and potato gratin', category: 'Meat',       tags: ['premium', 'classic'] },
];
...
/** Mock mode when no real Mealie token/URL is configured. */
...
function recipeImageUrl(id: string): string {
  ...
  // Both original.webp and min-original.webp exist for recipes with images.
